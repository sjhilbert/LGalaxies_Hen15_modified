...
# 1 "/afs/mpa/home/hilbert/work/code/LGalaxies/LGalaxies_Hen15_PublicRelease-master-modified//"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 353 "./code/allvars.h"
  ...
  float dObsMagDust[20];
  float dObsMag[20];
  float dObsMagBulge[20];





  float dObsMagDust_forward[20];
  float dObsMag_forward[20];
  float dObsMagBulge_forward[20];
# 381 "./code/allvars.h"
  float MassWeightAge;
...
extern FILE *FdLightconeGalDumps[64];


extern long long TotLightconeGalCount;
extern long long TotLightconeGalaxies[64];


extern float lightcone_slice_lower_redshift [64];
extern float lightcone_slice_upper_redshift [64];

extern float lightcone_slice_lower_los_distance [64];
extern float lightcone_slice_upper_los_distance [64];

extern float lightcone_radius_for_snapshot [64];
extern 
# 1212 "./code/allvars.h" 3 4
      _Bool 
# 1212 "./code/allvars.h"
            is_outside_lightcone_for_snapshot [64];
extern 
# 1213 "./code/allvars.h" 3 4
      _Bool 
# 1213 "./code/allvars.h"
            check_outside_lightcone_for_snapshot[64];
...
# 68 "./code/lightcone_galaxy_output_type.h"
  ...
  int Type;
# 91 "./code/lightcone_galaxy_output_type.h"
  int SnapNum;
  float CentralMvir;
  float DistanceToCentralGal[3];
  ...
  float GasDiskRadius;
  float CosInclination;
# 136 "./code/lightcone_galaxy_output_type.h"
  float ObsMagDust[20];
  float ObsMag[20];
  float ObsMagBulge[20];
...
# 166 "./code/lightcone_galaxy_output_type.h"
static inline void
galaxy_output_to_lightcone_galaxy_output_type(const struct GALAXY_OUTPUT *galaxy_, lightcone_galaxy_output_type *lightcone_galaxy_)
{
  ...
  int i_;
# 207 "./code/lightcone_galaxy_output_type.h"
...
# 234 "./code/lightcone_galaxy_output_type.h"
...
# 289 "./code/lightcone_galaxy_output_type.h"
  for(i_ = 0; i_ < 20; i_++)
...
# 340 "./code/lightcone_galaxy_output_type.h"
  galaxy_->GalID += big_offset_;
  galaxy_->FOFCentralGal += big_offset_;
# 371 "./code/lightcone_galaxy_output_type.h"
}
