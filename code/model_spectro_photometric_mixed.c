  ...
  if(age > 0)
      ...
      else
	{
	  /*
	     idx = 1;
	   */
	  idx = get_SSP_log_age_jump_index(age);
...
//                                          
//         Gal[galaxy_number_].Lum[filter_number_][output_bin_] += LuminosityToAdd;
// 
//         /*luminosity used for extinction due to young birth clouds */
//         if(is_affected_by_birthclould_)
//           Gal[galaxy_number_].YLum[filter_number_][output_bin_] += LuminosityToAdd;
//       }
...
//                                                        
//         Gal[galaxy_number_].ObsLum[filter_number_][output_bin_] += LuminosityToAdd;
//   
//         if(is_affected_by_birthclould_)
//           Gal[galaxy_number_].ObsYLum[filter_number_][output_bin_] += LuminosityToAdd;
//       }
//       
// #ifdef OUTPUT_MOMAF_INPUTS
...
//                                                        f_age_2_ * LumTables[age_index_ + 1][met_index_ + 1][redshift_index_][filter_number_]));
//                                                        
//         Gal[galaxy_number_].dObsLum[filter_number_][output_bin_] += LuminosityToAdd;
// 
//         if(is_affected_by_birthclould_)
//           Gal[galaxy_number_].dObsYLum[filter_number_][output_bin_] += LuminosityToAdd;
//       }
//       
// #ifdef KITZBICHLER
...
//                                                        f_age_2_ * LumTables[age_index_ + 1][met_index_ + 1][redshift_index_][filter_number_]));
//                                                        
//         Gal[galaxy_number_].dObsLum_forward[filter_number_][output_bin_] += LuminosityToAdd;
// 
//         if(is_affected_by_birthclould_)
//           Gal[galaxy_number_].dObsYLum_forward[filter_number_][output_bin_] += LuminosityToAdd;
//       }
